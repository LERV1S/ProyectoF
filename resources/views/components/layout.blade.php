...
<html class="fixed">
	...
	<body>
		<section class="body">
			...
			<header class="header">
				<div class="logo-container">
					<a href="../" class="logo">
						<img src="assets/images/pr.png" height="75" alt="JSOFT Admin" />
					</a>
			...
			<!-- end: header -->
				...
				<!-- start: sidebar -->
				@include('parciales.menui');
				<!-- end: sidebar -->


            <!-- start: sidebar-Right -->
			    @include('parciales.menuR');
			<!-- end: sidebar-Right -->
		...
		<script src="{{ asset('assets/vendor/magnific-popup/magnific-popup.js') }}assets/vendor/magnific-popup/magnific-popup.js"></script>
		...
		<script src="{{ asset('assets/vendor/jqvmap/jquery.vmap.js0') }}"></script>
